...
/**
 * This class is based on Theme_pyroCMS class, which is the theme for pyrocms admin style
 * Instead of using default admin theme, use this class for different style
 */
class Theme_Jchurch extends Theme {

    public $name = 'Jchurch';
    public $author = 'Jongha Hwang';
    public $author_website = 'http://www.jchurch.us/';
    public $website = 'http://www.jchurch.us/';
    public $description = 'Jchurch Theme.';
    public $version = '1.0';
