...
<?php if ($this->method == 'create'): ?>
	<h4><?php echo lang('board:create_title'); ?></h4>
<?php else: ?>
	<h4><?php echo sprintf(lang('board:edit_title'), $post->title); ?></h4>
<?php endif; ?>
</section>
...
<div class="tabs">
	...
	<ul class="tab-menu">
		<li><a href="#blog-content-tab"><span><?php echo lang('board:content_label'); ?></span></a></li>
		<li><a href="#blog-options-tab"><span><?php echo lang('board:options_label'); ?></span></a></li>
	</ul>
	...
	<div class="form_inputs" id="blog-content-tab">
		...
		<ul>
			...
			<li>
				<label for="status"><?php echo lang('board:status_label'); ?></label>
				<div class="input"><?php echo form_dropdown('status', array('draft' => lang('board:draft_label'), 'live' => lang('board:live_label')), $post->status) ?></div>
			</li>
			
			<li>
				<label for="intro"><?php echo lang('board:intro_label'); ?></label>
				<br style="clear: both;" />
				<?php echo form_textarea(array('id' => 'intro', 'name' => 'intro', 'value' => $post->intro, 'rows' => 5, 'class' => 'blog wysiwyg-simple')); ?>
			</li>
			
			<li class="editor">
				<label for="body"><?php echo lang('board:content_label'); ?></label>
				...
				<?php echo form_textarea(array('id' => 'body', 'name' => 'body', 'value' => $post->body, 'rows' => 10, 'class' => $post->type)); ?>
	...
	<div class="form_inputs" id="blog-options-tab">
		...
		<ul>
			<li>
				<label for="category_id"><?php echo lang('board:category_label'); ?></label>
				<div class="input">
				<?php echo form_dropdown('category_id', array(lang('board:no_category_select_label')) + $categories, @$post->category_id) ?>
			...
			<li class="date-meta">
				<label><?php echo lang('board:date_label'); ?></label>
			...
			<li>
				<label for="comments_enabled"><?php echo lang('board:comments_enabled_label');?></label>
...
<div class="buttons">
	<?php $this->load->view('partials/buttons', array('buttons' => array('save', 'save_exit', 'cancel'))); ?>
</div>
